...
Settings settingsOf(SettingsRow r) => Settings(
      ...
      backupFolderLabel: r.backupFolderLabel,
      lastAutoBackupAt: r.lastAutoBackupAt,
      lastAutoBackupError: r.lastAutoBackupError,
...
SubscriptionsCompanion subscriptionToRow(Subscription s) =>
    SubscriptionsCompanion.insert(
      ...
      shared: Value(s.shared),
      payTo: Value(s.payTo),
      payHow: Value(s.payHow),
...
SettingsTableCompanion settingsToRow(Settings s) => SettingsTableCompanion(
      ...
      backupFolder: Value(s.backupFolder),
      backupFolderLabel: Value(s.backupFolderLabel),
      lastAutoBackupAt: Value(s.lastAutoBackupAt),
      lastAutoBackupError: Value(s.lastAutoBackupError),
