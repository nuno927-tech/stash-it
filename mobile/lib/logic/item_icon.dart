...
const Map<IconKey, List<String>> keywords = {
  IconKey.fridge: [
    'fridge', 'refrigerator', 'freezer', 'ice maker', 'wine cooler', 'chiller',
  ],
  ...
  IconKey.oven: [
    'oven', 'stove', 'range', 'cooktop', 'hob', 'air fryer', 'toaster',
  ],
  ...
  IconKey.tv: [
    'tv', 'television', 'bravia', 'oled', 'qled', 'projector', 'monitor',
    'display',
  ],
  IconKey.laptop: [
    'laptop', 'macbook', 'notebook', 'computer', 'pc', 'desktop', 'chromebook',
  ],
  IconKey.phone: ['phone', 'iphone', 'pixel', 'galaxy', 'tablet', 'ipad'],
  IconKey.speaker: [
    'speaker', 'soundbar', 'sonos', 'stereo', 'headphone', 'earbud',
    'amplifier',
  ],
  ...
  IconKey.wrench: [
    'wrench', 'spanner', 'socket set', 'tool kit', 'toolkit', 'tool set',
  ],
  IconKey.mower: [
    'mower', 'lawn mower', 'lawnmower', 'strimmer', 'trimmer', 'hedge',
    'leaf blower',
  ],
  IconKey.grill: [
    'grill', 'bbq', 'barbecue', 'barbeque', 'smoker', 'pizza oven',
  ],
  IconKey.bike: ['bike', 'bicycle', 'e-bike', 'ebike', 'scooter'],
  IconKey.car: [
    'car', 'van', 'truck', 'suv', 'motorcycle', 'motorbike', 'caravan',
    'trailer',
  ],
  ...
  IconKey.table: [
    'table', 'desk', 'sideboard', 'dresser', 'wardrobe', 'cabinet', 'bookcase',
    'shelf',
  ],
  IconKey.lamp: ['lamp', 'light', 'chandelier', 'sconce', 'lantern'],
  IconKey.boiler: [
    'boiler', 'furnace', 'water heater', 'radiator', 'heat pump', 'thermostat',
    'heater',
  ],
  IconKey.aircon: [
    'air conditioner', 'air con', 'aircon', 'ac unit', 'hvac', 'fan',
    'dehumidifier', 'purifier',
  ],
  IconKey.vacuum: [
    'vacuum', 'hoover', 'roomba', 'steam cleaner', 'pressure washer',
  ],
