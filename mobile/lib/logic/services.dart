...
const List<ServiceDef> services = [
  ...
  ServiceDef(
    ...
    path:
        'M2 6h20v12H2z M4.5 9h3v1.2h-.9V15H5.4v-4.8h-.9zm5 0h1.2v6H9.5zm3 0h2.4c.7 0 1.2.6 1.2 1.4v3.2c0 .8-.5 1.4-1.2 1.4h-2.4zm1.2 1.2v3.6h.9v-3.6zm4.3-1.2h1.2v2.4h1.3V9h1.2v6h-1.2v-2.4H20V15h-1.2z',
  ),
  ServiceDef(
    id: 'hulu',
    name: 'Hulu',
    ...
    domain: 'hulu.com',
    path:
        'M3 4h3v6.2c.6-.8 1.5-1.3 2.7-1.3 2 0 3.3 1.3 3.3 3.5V20H9v-6.7c0-1.1-.6-1.8-1.6-1.8S6 12.2 6 13.3V20H3zm11 5.1h3v6.6c0 1.1.6 1.8 1.5 1.8s1.5-.7 1.5-1.8V9.1h3V16c0 2.5-1.7 4.2-4.5 4.2S14 18.5 14 16z',
  ),
  ServiceDef(
    id: 'max',
    name: 'Max',
    ...
    domain: 'max.com',
    path:
        'M1 7h3.2l2.1 6 2.1-6H11.6v10H9.1v-6.1L7.1 17H5.5L3.5 10.9V17H1zm12.4 0h2.6l2 3.3L20 7h2.6l-3.3 5 3.4 5h-2.7l-2-3.4-2 3.4h-2.7l3.4-5z',
  ),
  ServiceDef(
    id: 'appletv',
    name: 'Apple TV+',
  ...
  ServiceDef(
    ...
    path:
        'M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 3.5c1 0 1.8.8 1.8 1.8S13 9.1 12 9.1s-1.8-.8-1.8-1.8S11 5.5 12 5.5zM7.4 8.9c1 0 1.8.8 1.8 1.8s-.8 1.8-1.8 1.8-1.8-.8-1.8-1.8.8-1.8 1.8-1.8zm9.2 0c1 0 1.8.8 1.8 1.8s-.8 1.8-1.8 1.8-1.8-.8-1.8-1.8.8-1.8 1.8-1.8zM12 12.6c1 0 1.8.8 1.8 1.8s-.8 1.8-1.8 1.8-1.8-.8-1.8-1.8.8-1.8 1.8-1.8z',
  ),
  ServiceDef(
    id: 'audible',
    name: 'Audible',
    ...
    domain: 'audible.com',
    path:
        'M12 2.4 1.5 9v2.1L12 4.5l10.5 6.6V9zM1.5 13.2v2.1L12 21.9l10.5-6.6v-2.1L12 19.8zm0-2.1 10.5 6.6 10.5-6.6-1.6-1L12 16 3.1 10.1z',
  ),
  ServiceDef(
    id: 'dropbox',
    name: 'Dropbox',
    ...
    domain: 'dropbox.com',
    path:
        'M6 1.807 0 5.629l6 3.822 6.001-3.822L6 1.807zM18 1.807l-6 3.822 6 3.822 6-3.822-6-3.822zM0 13.274l6 3.822 6.001-3.822L6 9.452l-6 3.822zM18 9.452l-6 3.822 6 3.822 6-3.822-6-3.822zM6 18.371l6.001 3.822 6-3.822-6-3.822L6 18.371z',
  ),
  ServiceDef(
    id: 'googleone',
    name: 'Google One',
  ...
  ServiceDef(
    ...
    path:
        'M2 3.5 14 1v22L2 20.5zm13 3.2h7V17h-7zm0-1.2V1l7 1.2v2.3zm0 13.5v4.3l7-1.2v-2.3z',
  ),
  ServiceDef(
    id: 'adobecc',
  ...
  ServiceDef(
    ...
    path:
        'M2 5h20a1 1 0 011 1v10a1 1 0 01-1 1H2a1 1 0 01-1-1V6a1 1 0 011-1zm8 3v6l5-3zM7 20h10v1.5H7z',
  ),
  ServiceDef(
    id: 'ring',
    name: 'Ring Protect',
    ...
    domain: 'ring.com',
    path:
        'M12 2a7 7 0 00-7 7v4.6l-2 3.4h18l-2-3.4V9a7 7 0 00-7-7zm0 20a3 3 0 002.8-2H9.2A3 3 0 0012 22z',
  ),
  ServiceDef(
    id: 'nest',
    name: 'Nest Aware',
    ...
    domain: 'nest.com',
    path:
        'M12 2a10 10 0 100 20 10 10 0 000-20zm0 3.5A6.5 6.5 0 1112 18.5 6.5 6.5 0 0112 5.5zm0 3A3.5 3.5 0 1012 15.5 3.5 3.5 0 0012 8.5z',
  ),
  ServiceDef(
    id: 'kindle',
    ...
    domain: 'amazon.com',
    path:
        'M4 3.5h7a2 2 0 012 2V21a2.5 2.5 0 00-2-1H4zm16 0h-7a2 2 0 00-2 2V21a2.5 2.5 0 012-1h7z',
  ),
  ServiceDef(
    id: 'water',
    name: 'Water delivery',
    colour: 0xFF6AA9FF,
    path:
        'M12 2.5S5.5 10 5.5 14.5a6.5 6.5 0 0013 0C18.5 10 12 2.5 12 2.5zm0 3.9c1.6 2.1 4.5 6.3 4.5 8.1a4.5 4.5 0 01-9 0c0-1.8 2.9-6 4.5-8.1z',
  ),
  ServiceDef(
    id: 'appleone',
    name: 'Apple One',
  ...
  ServiceDef(
    ...
    domain: 'apple.com',
    path:
        'M6 4h12a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3zm1.5 4v2h-2v2h2v2h2v-2h2v-2h-2V8zm8 1a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zm2.5 3.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z',
  ),
  ServiceDef(
    id: 'crunchyroll',
    name: 'Crunchyroll',
    ...
    path:
        'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-1.2 4.8a7.2 7.2 0 0 1 7.2 7.2 4.8 4.8 0 0 1-4.8 4.8 2.4 2.4 0 0 0 2.4-2.4 7.2 7.2 0 0 1-7.2-7.2 4.8 4.8 0 0 1 4.8-4.8 2.4 2.4 0 0 0-2.4 2.4z',
  ),
  ServiceDef(
    id: 'espn',
    name: 'ESPN+',
    ...
    domain: 'espn.com',
    path:
        'M2 8h6v1.6H4v1.4h3.4v1.6H4V14h4v1.6H2zm7.4 0h4.3c1.3 0 2 .7 2 1.8 0 .8-.4 1.4-1.1 1.6.9.2 1.4.9 1.4 1.9 0 1.4-.9 2.3-2.4 2.3H9.4zm2 1.5v1.5h1.8c.5 0 .8-.3.8-.8s-.3-.7-.8-.7zm0 3v1.6h2c.6 0 .9-.3.9-.8s-.3-.8-.9-.8zM17 8h2v7.6h-2z',
  ),
  ServiceDef(
    id: 'nordvpn',
    name: 'NordVPN',
  ...
  ServiceDef(
    ...
    path:
        'M12 1 2 6.5v11L12 23l10-5.5v-11zm0 2.6 7.4 4.1-7.4 4-7.4-4zm-8 6 7 3.8v7.5l-7-3.8zm16 0v7.5l-7 3.8V13.4z',
  ),
  ServiceDef(
    id: 'notion',
    name: 'Notion',
  ...
  ServiceDef(
    ...
    domain: 'nytimes.com',
    path:
        'M3 4h18v2H3zm0 4h11v1.4H3zm0 3.2h11v1.4H3zm0 3.2h18V16H3zm0 3.4h18V20H3z',
  ),
  ServiceDef(
    id: 'medium',
    name: 'Medium',
  ...
  ServiceDef(
    ...
    domain: 'onedrive.com',
    path:
        'M10.5 5.5a6 6 0 0 1 5.5 3.6 4.5 4.5 0 0 1 4 4.4 4.5 4.5 0 0 1-4.5 4.5H6a4.5 4.5 0 0 1-.6-8.96A6 6 0 0 1 10.5 5.5z',
  ),
  ServiceDef(
    id: 'proton',
    name: 'Proton',
  ...
  ServiceDef(
    ...
    path:
        'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm1.2 5.4v7.1l-1.6-1.6-1.6 1.6V5.4zm-2.4 13.2v-2.9l1.6 1.6 1.6-1.6v2.9z',
  ),
  ServiceDef(
    id: 'grammarly',
    name: 'Grammarly',
    ...
    path:
        'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.5a7.5 7.5 0 0 1 6 3l-2 1.5a5 5 0 1 0 .9 4.5H12v-2.4h7.4A7.5 7.5 0 1 1 12 4.5z',
  ),
  ServiceDef(
    id: 'duolingo',
    name: 'Duolingo',
    ...
    domain: 'duolingo.com',
    path:
        'M12 2C7 2 3 6 3 11c0 4 2.5 7.4 6 8.6V22l2.2-1.6c.3 0 .5.1.8.1 5 0 9-4 9-9s-4-9-9-9zm-2.6 7.2a1.4 1.4 0 1 1 0 2.8 1.4 1.4 0 0 1 0-2.8zm5.2 0a1.4 1.4 0 1 1 0 2.8 1.4 1.4 0 0 1 0-2.8z',
  ),
  ServiceDef(
    id: 'headspace',
    name: 'Headspace',
    ...
    path:
        'M12 3C6.5 3 2 7 2 12s4.5 9 10 9 10-4 10-9-4.5-9-10-9zm0 3c3.9 0 7 2.7 7 6s-3.1 6-7 6-7-2.7-7-6 3.1-6 7-6z',
  ),
  ServiceDef(
    id: 'calm',
    name: 'Calm',
  ...
  ServiceDef(
    ...
    domain: 'coursera.org',
    path:
        'M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c2.7 0 5.1-1 6.9-2.7l-2.6-2.6A6.3 6.3 0 1 1 18.3 9l2.6-2.6A9.96 9.96 0 0 0 12 2z',
  ),
  ServiceDef(
    id: 'skillshare',
    name: 'Skillshare',
  ...
  ServiceDef(
    ...
    colour: 0xFF8B949E,
    path:
        'M7 2h10a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm0 3v13h10V5zm4 14.2h2v1.2h-2z',
  ),
  ServiceDef(
    id: 'internet',
    name: 'Internet',
    colour: 0xFF6AA9FF,
    path:
        'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zm0 2c1.3 0 2.6 2.3 3 5.3H9c.4-3 1.7-5.3 3-5.3zM5.2 10.3h2.6a17 17 0 0 0-.2 5.4H5.6a7 7 0 0 1-.4-5.4zm4.6 0h4.4c.2 1.7.2 3.7 0 5.4H9.8c-.2-1.7-.2-3.7 0-5.4zm6.4 0h2.6a7 7 0 0 1-.4 5.4h-2c.2-1.7.1-3.7-.2-5.4z',
  ),
  ServiceDef(
    id: 'insurance',
    name: 'Insurance',
    colour: 0xFFF2CE3D,
    path:
        'M12 2 4 5.5v6c0 4.6 3.2 8.9 8 10.5 4.8-1.6 8-5.9 8-10.5v-6zm0 2.2 6 2.6v4.7c0 3.5-2.4 6.9-6 8.3-3.6-1.4-6-4.8-6-8.3V6.8z',
  ),
  ServiceDef(
    id: 'other',
    name: 'Something else',
    colour: 0xFF8B949E,
    path:
        'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 4.5a3.2 3.2 0 0 1 3.2 3.2c0 1.3-.8 2-1.8 2.7-.7.5-1 .8-1 1.5v.4h-1.8v-.6c0-1.3.7-2 1.6-2.7.8-.5 1.2-.9 1.2-1.4a1.4 1.4 0 0 0-2.8 0H9.2A3.2 3.2 0 0 1 12 6.5zm-1.2 10.2h2.4v2.1h-2.4z',
  ),
];
