...
class _ItemFormSheetState extends State<_ItemFormSheet> {
  ...
  */
  ...
  Widget _roomCard(StashColors c) {
    return SheetCard(
      title: 'Room',
      action: FormPill(label: 'New room', onTap: _newRoom),
      children: [
  ...
  Widget _warrantyCard(StashColors c) {
    /*
      The control itself is `CoverageList`, shared with the step-by-step sheet.

      It used to be two hundred lines here. The wizard asks the same question,
      and the same question has to mean the same control — the same six names,
      four units, presets, Additional details disclosure and "+ Add another
      policy". Two copies would have started identical and drifted the first
